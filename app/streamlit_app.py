"""
Streamlit UI for the PGP Agentic RAG application.
...
st.caption(
    "Upload enterprise documents (PDF, TXT, CSV, Excel) and ask questions. "
    "Powered by Gemini (Vertex AI) + RAG + Agentic workflow."
)
...
with st.sidebar:
    ...
    st.markdown(
        ...
        "_Make sure Vertex AI credentials are configured._"
    )
